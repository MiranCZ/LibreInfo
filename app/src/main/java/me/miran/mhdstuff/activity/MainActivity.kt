...
class MainActivity : NavigationActivity(R.string.app_name) {
    ...
    override fun CreateNavigation() {
        ...
        NavigationItem(R.drawable.location_arrow, R.string.vehicle_map, VehicleMapActivity::class)
        NavigationItem(R.drawable.list_ul_regular, R.string.vehicles, VehiclesListActivity::class)
        NavigationItem(R.drawable.bolt_regular, R.string.events, EventsActivity::class)
        NavigationItem(R.drawable.triangle_exclamation_regular, R.string.diversions, DiversionsActivity::class)
